                ...
                <div className="card-body p-0">
                    <div className="row">
                        ...
                        <div className="col-lg-5 d-none d-lg-flex">
                            <div className="flex-grow-1 bg-register-image" style={{ backgroundImage: "url(../dessert4.jpg)" }}></div>
                        </div>
                            ...
                            <div className="p-5">
                                ...
                                <form className="user" ref={fref} onSubmit={handleSubmit}>
                                    <div className="form-group row">
                                        <div className="col-sm-6 mb-3 mb-sm-0"><input className="form-control form-control-user" type="text" id="exampleFirstName" placeholder="First Name" name="firstName" /></div>
                                    ...
                                    <div className="form-group"><input className="form-control form-control-user" type="number" id="exampleInputPhone" aria-describedby="phoneHelp" placeholder="Phone Number" name="phone" /></div>
                                    <div className="form-group row">
